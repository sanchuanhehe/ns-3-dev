...
The ns-3 GitLab repository uses labels to help track and manage issues and merge requests. The labels currently used are listed in the [GitLab labels](https://gitlab.com/nsnam/ns-3-dev/-/labels) page.
