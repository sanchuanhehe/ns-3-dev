...
struct StandardInfo
{
    ...
    StandardInfo(std::string name,
                 ...
                 WifiPhyBand band,
                 MHz_u width,
                 units::power::dB_t snrLow,
                 units::power::dB_t snrHigh,
                 double xMin,
                 double xMax,
                 double yMax)
        : m_name(name),
    ...
    units::power::dB_t m_snrLow;           ///< lowest SNR
    units::power::dB_t m_snrHigh;          ///< highest SNR
                          ...
                          Gnuplot2dDataset& actualDataset)
{
    ...
    units::power::dB_t snr{rss - noise};
