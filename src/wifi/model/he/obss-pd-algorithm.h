...
class ObssPdAlgorithm : public Object
{
  public:
     ...
     */
    void SetObssPdLevel(units::power::dBm_t level);
    /**
     * @return the current OBSS PD level
     */
    units::power::dBm_t GetObssPdLevel() const;
  ...
  private:
    units::power::dBm_t m_obssPdLevel;    ///< Current OBSS PD level
    units::power::dBm_t m_obssPdLevelMin; ///< Minimum OBSS PD level
    units::power::dBm_t m_obssPdLevelMax; ///< Maximum OBSS PD level
    units::power::dBm_t m_txPowerRefSiso; ///< SISO reference TX power level
    units::power::dBm_t m_txPowerRefMimo; ///< MIMO reference TX power level
