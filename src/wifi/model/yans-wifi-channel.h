...
class YansWifiChannel : public Channel
{
  public:
     ...
     */
    void Send(Ptr<YansWifiPhy> sender, Ptr<const WifiPpdu> ppdu, units::power::dBm_t txPower) const;
  ...
  private:
     ...
     */
    static void Receive(Ptr<YansWifiPhy> receiver, Ptr<const WifiPpdu> ppdu, units::power::dBm_t txPower);
